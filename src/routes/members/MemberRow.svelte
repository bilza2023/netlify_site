    ...
    <td class="border text-center">
      <input 
       disabled={disabledVar} 
        ...
        {disabledVar == true ? "bg-gray-600" : "bg-red-900" }
        "
...
<td class="p-1 border 
{ disabledVar == false ? "bg-red-900 hover:bg-red-700" : "bg-gray-700 hover:bg-gray-800"}
 text-center text-white  active:bg-gray-800 rounded-md transition duration-200" >
<button on:click={()=>{disabledVar = !disabledVar; dirty.set(true);}}>
...
stroke= { disabledVar == false ? "white" : "gray"} 
stroke-width="1.5" 
