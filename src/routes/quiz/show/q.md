THis is my page.svelte in my svelte app
...
and this is the error code from browser it generates ==>
{quiz: {…}}quiz: farewellText: "farewellText farewellText farewellText farewellText farewellText farewellText farewellText farewellText "introText: "introText introText introText introText introText introText inText introText introText introText "questions: (3) [{…}, {…}, {…}]saveResponse: trueshowIntro: trueshowResult: "true"title: "The Most Comprehensive Quiz Test"userId: "640c60780a87835ced6122af"__v: 0_id: "6411609828a369b541fcd7d7"[[Prototype]]: Object[[Prototype]]: Object
proxy.js?v=b64b20d2:15 [HMR][Svelte] Unrecoverable HMR error in <QuizComp>: next update will trigger a full reload
logError @ proxy.js?v=b64b20d2:15
Proxy<QuizComp> @ proxy.js?v=b64b20d2:380
create_if_block_1 @ +page.svelte:49
update @ +page.svelte:59
update @ index.mjs:1209
flush @ index.mjs:1169
Promise.then (async)
schedule_update @ index.mjs:1120
make_dirty @ index.mjs:1984
(anonymous) @ index.mjs:2022
(anonymous) @ +page.svelte:5
set @ index.mjs:34
click_handler_1 @ Intro.svelte? [sm]:36
QuizComp.svelte? [sm]:42 Uncaught (in promise) TypeError: Cannot read properties of undefined (reading '0')
    at create_fragment (QuizComp.svelte? [sm]:42:15)
    at init (index.mjs:2031:37)
    at new QuizComp (QuizComp.svelte? [sm]:69:36)
    at createProxiedComponent (svelte-hooks.js?v=b64b20d2:341:9)
    at new ProxyComponent (proxy.js?v=b64b20d2:242:7)
    at new Proxy<QuizComp> (proxy.js?v=b64b20d2:349:11)
    at create_if_block_1 (+page.svelte:49:37)
    at Object.update [as p] (+page.svelte:59:21)
    at update (index.mjs:1209:36)
    at flush (index.mjs:1169:17)
create_fragment @ QuizComp.svelte? [sm]:42
init @ index.mjs:2031
QuizComp @ QuizComp.svelte? [sm]:69
createProxiedComponent @ svelte-hooks.js?v=b64b20d2:341
ProxyComponent @ proxy.js?v=b64b20d2:242
Proxy<QuizComp> @ proxy.js?v=b64b20d2:349
create_if_block_1 @ +page.svelte:49
update @ +page.svelte:59
update @ index.mjs:1209
flush @ index.mjs:1169
...
please check to see what is causing this error