...
let members = [
{id:1 ,name: "John" , description : "abc xyz" ,clean : true},
{id:2 ,name: "Jim"  , description : "abc xyz" ,clean : true},
{id:3 ,name: "Tariq", description : "abc xyz" ,clean : true},
{id:4 ,name: "Mike" , description : "abc xyz" ,clean : true},
];
// $: dirty = $storeDirty;
...
<table class="w-8/12 text-white border-separate rounded mx-auto">
  ...
  <tr>
    ...
    <td class="border text-center">
      <input 
       disabled={ member.clean} 
        ...
        "
        type="text"   bind:value = {member.name}
      >
    </td>
    ...
    {member.clean == true ? "bg-gray-600" : "bg-red-900" }
    "
    type="text"   bind:value = {member.password}
    >
    </td> 
